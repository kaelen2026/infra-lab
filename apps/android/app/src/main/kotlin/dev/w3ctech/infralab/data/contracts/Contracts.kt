 ...
 *
 * The `Platform` / `AuthErrorCode` enums and their tolerant serializers are generated from the
 * shared contracts into `AuthContractEnums.generated.kt` (same package). Run `pnpm gen:design`.
 */
